            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
                        <div class="hero-copy">
                            <h1 class="hero-title h2-mobile mt-0 is-revealing">Welcome to  Stephanie's MailerLite App</h1>
                            <p class="hero-paragraph is-revealing">Manage your subscribers easily and efficiently.</p>
                            <p class="hero-cta is-revealing"><a class="button button-primary button-shadow" href="{{ route('subscribers.create') }}">Add New Subscriber</a></p>
                            <p class="hero-cta is-revealing"><a class="button button-primary button-shadow" href="{{ route('subscribers.index') }}">View Subscribers</a></p>
                        </div>
